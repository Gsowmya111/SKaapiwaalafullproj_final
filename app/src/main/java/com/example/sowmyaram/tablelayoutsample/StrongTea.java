...
/////////////////////////////////////////////////////////////////
        ...
        bback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(half_back.equals("halfcup_page")){
                    Intent  i=new Intent(StrongTea.this, Halfcup_page.class);
                    startActivity(i);
                    finish();
                }else if(half_back.equals("fullcup_page")) {

                    Intent i = new Intent(StrongTea.this, FullCup_page.class);
                    startActivity(i);
                    finish();
                }
            }
    ...
    public  void spinnermethod()
    {
        ...
        AlertDialog.Builder alert = new AlertDialog.Builder(StrongTea.this);
        ...
        if(spinertextval.equals("etmilkval")){
            s.setAdapter(new MyAdapter(StrongTea.this, R.layout.spinner_item, arraySpinner_milk));
        }else if(spinertextval.equals("etcoffeev")){
            s.setAdapter(new MyAdapter(StrongTea.this, R.layout.spinner_item, arraySpinner_tea));
        }/*else if(spinertextval.equals("etsugarv")){
            s.setAdapter(new MyAdapter(StrongTea.this, R.layout.spinner_item, arraySpinner_sugar));
        }*/
                ...
                case 0: {
                    try {
                        ...
                        if ((message.startsWith("*")) && (message.endsWith("#"))  && message.length() <= 5) {
                            ...
                            //setting values to tea and milk from spinner
